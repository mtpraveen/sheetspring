...
private static FirebaseApp mfirebaseApp = null;
	...
	{	
		...
		DatabaseReference lRef = FirebaseDatabase.getInstance( firebaseApp ).getReference("LinkedIn Details");
	...
	{	
		...
		// As an admin, the app has access to read and write all data, regardless of Security Rules
		DatabaseReference lRef = FirebaseDatabase.getInstance().getReference("Engineer");
		DatabaseReference lUsersRef = lRef.child(pKey);
